...
function h_meta_multiline(string $s): string {
  $parts = preg_split('/\r\n|\r|\n/u', (string)$s) ?: [];
...
<head>
  ...
  <meta name="description" content="<?= h_meta_multiline($projectDescription) ?>">
  <meta itemprop="name" content="<?= h($projectName) ?>">
  <meta itemprop="description" content="<?= h_meta_multiline($projectDescription) ?>">

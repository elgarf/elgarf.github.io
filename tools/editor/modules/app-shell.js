const EDITOR_ELEMENT_IDS = [
  ...
  "snapGrid", "snapObjects", "snapCenters", "snapGaps", "emptySelectionHint", "objectNameField", "rectTextSizeField", "noteArtRenderField", "propNoteArtRender", "quickGeoPanel", "propName", "propTextSize", "propTextSizeLabel", "propX", "propY", "propRot",
  "propWm", "propHm", "propScale", "shapePointPanel", "propShapePointX", "propShapePointY", "propShapePointType", "propAreaM2", "propAreaM2Width", "propAreaM2Height", "propAreaM2Badge", "propColorA", "colorBField", "propColorB", "shapeOpacityField", "propShapeOpacity", "btnAutoContrast", "btnRandomColor",
  ...
  "devicePropsPanel", "propDeviceType", "propDeviceOrientation", "propDeviceInCount", "propDeviceOutCount", "devicePortLabelField", "propDevicePortLabel", "btnAutoRouteDeviceOutLinks", "btnImproveDeviceOutLinks", "btnControllerLayoutEdit", "btnControllerLayoutResetInline", "btnControllerLayoutReset", "controllerLayoutBack",
...
export const createEditorDomRefs = (documentRef = document) => {
  ...
  const el = {
    ...
    shapePointType: $("propShapePointType"),
    scale: $("propScale"),
    areaM2: $("propAreaM2"),
    areaM2Width: $("propAreaM2Width"),
    areaM2Height: $("propAreaM2Height"),
    a: $("propColorA"),
    b: $("propColorB"),
